...
Player.prototype.moveY = function(step, level, keys) {
  ...
  //so if I were to set the first part of this if statement as "(obstacle = "wall") I can't fall or jump.  why does this happen when I set it equal to "wall" but not when it's just looking for any obstacle?
 
/* if (obstacle = "lava") 
  this.pos = pos.plus(new Vector(0, -0.5));
  ///I'm confident I'm using 'this' wrong, as this section only deals with y movement?  
*/
};
